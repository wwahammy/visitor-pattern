...
namespace VisitorPattern
{
	...
	[ToolkitInterfaceProxy(ExtensionId = "7abcea20-93c2-4584-8704-5c5bd2c47659", DefinitionId = "3d77b6de-b8c6-4119-8b37-c942402b36ea", ProxyType = typeof(VisitorPattern))]
	[System.CodeDom.Compiler.GeneratedCode("NuPattern Toolkit Library", "1.4.24.0")]
	[System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
	internal partial class VisitorPattern : IVisitorPattern
	{

		private Runtime.IProduct target;
		private IProductProxy<IVisitorPattern> proxy;

		/// <summary>
		/// Creates a new instance of the <see cref="VisitorPattern"/> class.
		/// </summary>
		...
		/// Creates a new instance of the <see cref="VisitorPattern"/> class.
		/// </summary>
		public VisitorPattern(Runtime.IProduct target)
		{
			this.target = target;
			this.proxy = target.ProxyFor<IVisitorPattern>();
			OnCreated();
		}
